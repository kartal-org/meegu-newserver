...
class ArticleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Article
        fields = ('id', "title", "abstract", "rating", "dateCreated",
                  "dateUpdated", "institution", "citation", "recommendation", "department", "status")
    ...
    def to_representation(self, instance):
        response = super().to_representation(instance)
        response["recommendation"] = RecommendationSerializer(
            instance.recommendation).data
        return response
...
class ReviewSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        response = super().to_representation(instance)
        response["user"] = AccountSerializer(
            instance.user).data
        return response
